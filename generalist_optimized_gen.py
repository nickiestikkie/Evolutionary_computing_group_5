...
experiment_name = 'generational_e3_test'
...
def main():
    # magic numbers
    generational_model = True # if generational_model = False, the steady-state model is applied
    individuals = 100
    hidden_neurons = 10
    lower_bound = -1
    upper_bound = 1
    ...
    for j in range(10):
        ...
        current_best_fitness = np.argmax(fitness)
        best_indiv = population[current_best_fitness]
